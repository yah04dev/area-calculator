...
root = tk.Tk()  
root.title('Calculator of square area')  
leng = tk.StringVar()  
wid = tk.StringVar()  

tk.Label(root, text="calculator of sauqre area By yah04").grid(row=1, column=0)  
...
bi = partial(bi, labelResult, leng, wid)  
